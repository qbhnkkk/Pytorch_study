...
def generate_mask():
    ground_dir = "D:/project/pytorch_stu/data/CrackForest-dataset/groundTruth"
    seg_dir = "D:/project/pytorch_stu/data/CrackForest-dataset/seg"
    # segnum, row, column1, column2
    ...
    for i in range(len(files)):
        ...
        cv.imwrite("D:/project/pytorch_stu/data/CrackForest-dataset/mask/%s.png" % (mask_file_name), result)
