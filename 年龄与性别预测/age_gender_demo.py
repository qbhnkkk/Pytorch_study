    ...
    while True:
        ...
        for detection in cvOut[0, 0, :, :]:
            ...
            if score > 0.5:
                ...
                # 绘制
                cv.putText(frame, ("gender: %s, age:%d" % (gender, int(predict_age[0][0]))), (int(left), int(top) - 15),
                           cv.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 1)
...
def face_age_gender_demo():
    ...
    model_xml = "D:/projects/models/face-detection-0202/FP32/face-detection-0202.xml"
    model_bin = "D:/projects/models/face-detection-0202/FP32/face-detection-0202.bin"
    ...
    cap = cv.VideoCapture("D:/project/data/video/example_dsh.mp4")
    exec_net = ie.load_network(network=net, device_name="CPU")

    # 加载性别与年龄预测模型
    em_net = ie.read_network(model="age_gender_model.onnx")
