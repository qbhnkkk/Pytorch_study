...
if __name__ == "__main__":
    ...
    ds = EmotionDataset("D:/project/pytorch_stu/data/emotion_dataset")
    ...
    # 损失函数
    cross_loss = torch.nn.CrossEntropyLoss()  # 交叉熵损失
    index = 0
    ...
    # save model
    model.eval()
    torch.save(model.state_dict(), 'face_emotions_model2.pt')
