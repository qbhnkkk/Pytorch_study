...
def face_emotions_demo():
    ...
    model_xml = "D:/project/pytorch_stu/model/intel/vehicle-detection-adas-0002/FP32/vehicle-detection-adas-0002.xml"
    model_bin = "D:/project/pytorch_stu/model/intel/vehicle-detection-adas-0002/FP32/vehicle-detection-adas-0002.bin"
    ...
    # 加载性别与年龄预测模型
    em_net = ie.read_network(model="face_emotions_model.onnx")
